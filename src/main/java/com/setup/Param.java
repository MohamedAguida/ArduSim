...
public class Param {
	...
	public static final String TAKEOFF_ALGORITHM = "TAKEOFFALGORITHM";
	...
	public static final String[] PARAMETERS = {COMPUTER_PORT, UAV_PORT, PROTOCOL, SPEED, MACS, TAKEOFF_ALGORITHM,
